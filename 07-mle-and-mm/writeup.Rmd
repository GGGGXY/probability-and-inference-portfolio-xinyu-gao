...
#### Glycohemoglobin
```{r}
hist(gh, breaks=20,freq=FALSE, main ="PDF OF gh")
...
#### Height
```{r}
hist(ht, breaks=20,freq=FALSE, main ="PDF OF ht")
...
plot(x_normal_gh,y_gh,asp=1,xlab = "Estimated quantile",ylab ="Sample quantile",main = "QQ Normal gh")
abline(0,1)
plot(x_gamma_gh,y_gh,asp=1,xlab = "Estimated quantile",ylab ="Sample quantile",main = "QQ Gamma gh")
abline(0,1)
plot(x_wb_gh,y_gh,asp=1,xlab = "Estimated quantile",ylab ="Sample quantile", main = "QQ Weilbull gh")
abline(0,1)
```
\
...
plot(x_normal_ht,y_ht,asp=1,xlab = "Estimated quantile",ylab ="Sample quantile",main = "QQ Normal ht" )
abline(0,1)
plot(x_gamma_ht,y_ht,asp=1,xlab = "Estimated quantile",ylab ="Sample quantile",main = "QQ Gamma ht")
abline(0,1)
plot(x_wb_ht,y_ht,asp=1,xlab = "Estimated quantile",ylab ="Sample quantile", main = "QQ Weilbull ht")
abline(0,1)
```
\
